// Hud Coin & life controller component
...
{
	var font1 = ( index % 10 );							// coin1 pos
	var font2 = ( ( index - font1 ) / 10 ) % 10;		// coin2 pos
	var font3 = ( ( index - font1 ) / 100 ) % 10;		// coin3 pos
	var font4 = ( index % 10 );							// lives pos
...
function Update ()
{
	...
	if (livesFont1 != null) aniSprite ( livesFont1, 10, 1, 0, 0, 10, "font4",lives );	// animated font sprite - type: font1
	if (coinFont1 != null) aniSprite ( coinFont1, 10, 1, 0, 0, 10, "font1",coin );	// animated font sprite - type: font2
	if (coinFont2 != null) aniSprite ( coinFont2, 10, 1, 0, 0, 10, "font2",coin );	// animated font sprite - type: font3	
